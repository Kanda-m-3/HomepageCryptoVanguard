  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            ...
            <h1 className="text-xl font-bold text-[hsl(var(--dark-navy))]">
              Crypto Vanguard
            </h1>
          </div>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl text-center text-[hsl(var(--dark-navy))]">
              利用規約
            </CardTitle>
          ...
          <CardContent className="prose max-w-none">
            <div className="space-y-6 text-black">
              <p>
                株式会社L'ART group（以下「当社」といいます。）が運営するDiscordサーバー「Crypto Vanguard」（以下「本サーバー」といいます。）の利用者（以下「ユーザー」といいます。）は、本利用規約（以下「本規約」といいます。）に同意のうえ、本サーバーを利用するものとします。本サーバーの利用に際しては、別途定める「プライバシーポリシー」およびDiscord Inc.が定める利用規約・ガイドラインも併せて適用されます。
              </p>

              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">1. 適用範囲および同意</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">2. 定義</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">3. 本サービスの内容</h2>
                <ol className="list-decimal list-inside space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">4. アカウントおよび登録情報</h2>
                <ol className="list-decimal list-inside space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">5. サブスクリプション</h2>
                
                <div className="ml-4">
                  <h3 className="text-lg font-semibold text-[hsl(var(--dark-navy))] mb-2">5.1 登録手続</h3>
                  ...
                  <h3 className="text-lg font-semibold text-[hsl(var(--dark-navy))] mb-2">5.2 利用料金および支払方法</h3>
                  <ol className="list-decimal list-inside space-y-2 mb-4">
                    <li>利用料金および支払方法は当社が別途定めるとおりとします。</li>
                    <li>利用料金は前払方式とし、当社が指定する決済代行サービスを通じて決済されます。</li>
                  </ol>

                  <h3 className="text-lg font-semibold text-[hsl(var(--dark-navy))] mb-2">5.3 更新・解約</h3>
                  <ol className="list-decimal list-inside space-y-2 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-[hsl(var(--dark-navy))] mb-2">5.4 サービス停止・解除</h3>
                  <ol className="list-decimal list-inside space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">6. ユーザーの責任</h2>
                <ol className="list-decimal list-inside space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">7. 禁止事項</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">8. 知的財産権</h2>
                <ol className="list-decimal list-inside space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">9. 免責事項</h2>
                <ol className="list-decimal list-inside space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">10. リスク開示（暗号資産等）</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">11. 退会・利用停止</h2>
                <ol className="list-decimal list-inside space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">12. 規約の変更</h2>
                <ol className="list-decimal list-inside space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">13. 権利義務の譲渡禁止</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">14. 分離可能性</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">15. 準拠法および管轄裁判所</h2>
                <ol className="list-decimal list-inside space-y-2">
              ...
              <section>
                <h2 className="text-xl font-bold text-[hsl(var(--dark-navy))] mb-3">16. お問い合わせ</h2>
